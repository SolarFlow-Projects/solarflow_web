...
export default function OverlayForm(props: propsOverlay) {
    ...
    return (
      <>
      <div className="fixed inset-0 bg-black/30 flex items-center justify-center px-4" onClick={() => props.setShow(false)}>
      </div>
        <div className="bg-white rounded-2xl lg:rounded-3xl  px-7 lg:px-10 py-14 lg:py-[67px] shadow-lg w-full max-w-[650px] z-10 fixed top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 overflow-y-auto  max-lg:max-h-[90vh]">
        <button className="fixed top-4 right-4 bg-main rounded-full text-white p-1 lg:p-1.5" onClick={() => props.setShow(false)}>
        ...
        <form action="" className="">
          <h3 className='text-[18px] md:text-[21px] lg:text-[24px] text-black font-bold h-full mb-[20px] uppercase'>{props.title}</h3>
          ...
          <div className="flex flex-col gap-y-3 lg:gap-y-4">
            ...
            <div className="flex flex-col-reverse lg:flex-row-reverse gap-x-2 lg:gap-x-3 gap-y-3 lg:gap-y-4">
              ...
              <div className="flex flex-col w-full">
                ...
                <details id="modulo" className="px-3 min-h-[45px] border border-dark-blue rounded-lg lg:rounded-xl py-3 group">
                  <summary className="flex w-full flex-row justify-between items-center tracking-[-0.28px] group-open:mb-[17px]">
                    ...
                    <span className="hidden group-open:flex">Selecione uma opção</span>
                  ...
                  <ul className="flex flex-col pl-4 lg:pl-2 gap-y-[17px]">
