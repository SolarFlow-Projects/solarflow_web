...
export default function OverlayForm(props: propsOverlay) {
    ...
    return (
      ...
      <div className="fixed inset-0 bg-black/30 flex items-center justify-center px-4" onClick={() => changeOverlay()}>
        ...
        <div className="bg-white rounded-2xl lg:rounded-3xl  px-7 lg:px-10 pt-12 pb-7 lg:pt-[67px] lg:pb-10 shadow-lg w-full max-w-[650px] z-10 fixed top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 ">
