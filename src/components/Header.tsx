...
export default function Header() {
    ...
    return(
        <header className="flex w-full justify-between items-center px-[25px] pt-[25px] max-w-[1280px] mx-auto mb-[120px] lg:mb-[50px]">
            ...
            <button 
            className='relative flex items-center gap-2 rounded-lg border border-main text-main px-4 py-2.5 font-medium overflow-hidden cursor-pointer transition-all duration-300 ease-out hover:text-white hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 active:shadow-md group' 
            onClick={() => navigate(-1)}
            >
